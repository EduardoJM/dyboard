import React, { useState, createRef, MouseEvent, ChangeEvent, useEffect } from 'react';
...
const ColorDropDown: React.FC<ColorDropDownProps> = ({
    ...
    const currentColor = getColorFromString(color);
    // dropDown state
    ...
    useEffect(() => {
        ...
        setHexNewColor(HSBtoHEX(newColorTemp));
    ...
    function handleSubmit() {
        setVisible(false);
        onSubmit(HSBtoHEX(displayNewColor));
    }
